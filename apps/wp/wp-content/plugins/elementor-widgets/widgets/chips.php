 ...
 * @since 1.0.0
 */
class Elementor_Chips extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Chips', 'elementor-chips-widget');
    }
    ...
    {
        return ['chips', 'tags', 'choices', 'options'];
    }
...
?>
    ...
    ?>
        <#
            html_tag={ 'ordered' : 'ol' , 'unordered' : 'ul' , 'other' : 'ul' ,
            };
